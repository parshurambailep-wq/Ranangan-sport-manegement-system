...
export default function EventRegistrationPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white px-10 py-8 flex flex-col gap-6">
      <h1 className="text-3xl font-bold">Event Registration Payment</h1>
      <div className="grid gap-6 md:grid-cols-[2fr_1fr]">
        <form onSubmit={handleSubmit} className="space-y-4 bg-black/40 border border-white/5 rounded-2xl p-6">
          <div>
        ...
        <div className="bg-black/40 border border-white/5 rounded-2xl p-6">
          <h2 className="text-lg font-semibold mb-2">UPI QR</h2>
          <div className="h-40 w-40 border border-dashed border-white/20 rounded-xl flex items-center justify-center mb-3">
          ...
          <p className="text-xs text-gray-400">
            1. Scan the UPI QR using GPay or any UPI app.
            <br />
            2. Complete payment.
            <br />
            3. Paste the UPI transaction ID above and submit.
            <br />
            4. Your payment will be verified by admin.
          </p>
        </div>
      </div>
    </div>
